...
namespace argb
{
    class HttpServer
    {
        ...
        {
            enum State { RECEIVING_REQUEST, RUNNING_HANDLER, WRITING_RESPONSE_HEADER, WRITING_RESPONSE_BODY, CLOSED };
            State                    state;
        ...
        struct ListenerScopeGuard { TcpListener& listener; ~ListenerScopeGuard() { listener.close(true); } };
    ...
    public:
        ...
        void run(const Port& local_port) { run(Address::any, local_port); }
